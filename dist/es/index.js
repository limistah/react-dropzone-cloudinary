...
const nooped = function nooped(fn) {
  return typeof fn === 'function' ? fn : function () {};
};

function DropzoneCloudinary(_ref) {
  let dropzoneOptions = _ref.dropzoneOptions,
  ...
  const handleFileDrop = useCallback((acceptedFiles) => {
    setProgress(0);
    const uploadClient = cloudinaryClient(_objectSpread({}, _cloudinaryConfig, {
